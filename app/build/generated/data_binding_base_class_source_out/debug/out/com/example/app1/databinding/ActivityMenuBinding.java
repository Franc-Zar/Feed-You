...
public final class ActivityMenuBinding implements ViewBinding {
  ...
  private ActivityMenuBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar toolbarMenu) {
  ...
  public static ActivityMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Toolbar toolbarMenu = ViewBindings.findChildViewById(rootView, id);
      if (toolbarMenu == null) {
        break missingId;
      }

      return new ActivityMenuBinding((ConstraintLayout) rootView, toolbarMenu);
    }
