...
public final class ActivityErrorBinding implements ViewBinding {
  ...
  private ActivityErrorBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar appBar,
      @NonNull ImageView imageView, @NonNull TextView tvSorry) {
    this.rootView = rootView;
    this.appBar = appBar;
    this.imageView = imageView;
    this.tvSorry = tvSorry;
  }
  ...
  public static ActivityErrorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_sorry;
      TextView tvSorry = ViewBindings.findChildViewById(rootView, id);
      if (tvSorry == null) {
        break missingId;
      }

      return new ActivityErrorBinding((ConstraintLayout) rootView, appBar, imageView, tvSorry);
    }
